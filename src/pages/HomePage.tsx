  ...
  return (
    <div className=" text-white h-screen w-full mx-4">
      ...
      <div className="w-full h-1/4 my-5 flex gap-3">
        <div className="w-2/6  bg-[rgb(134,139,147)] rounded-xl bg-opacity-15 border border-purple-200	 shadow-4xl p-2 overflow-auto">
        ...
        <div className="w-1/4 bg-[rgb(134,139,147)] rounded-xl bg-opacity-15 border border-purple-200	 shadow-4xl overflow-auto p-2">
            <DolarTala />
        </div>
